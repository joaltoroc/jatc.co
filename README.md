...
- **Optimización LCP (Largest Contentful Paint):** La imagen principal del avatar (procesada dinámicamente por Astro) se pre-cargará de forma prioritaria con su ruta optimizada mediante tags `<link rel="preload" fetchpriority="high">`.
