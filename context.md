...
- **Accesibilidad y UX (Apple Design System):**
  ...
  - Exportación en PDF profesional por secciones independientes: reglas explícitas de salto de página (`break-before: page; page-break-before: always;`) para cada una de las 8 secciones principales con márgenes de caja `@page { size: portrait; margin: 1.2cm 1.5cm; }` y ocultamiento automático de controles interactivos (asistente de IA, modales y botones flotantes).
